                ...
                <Scroll>
                    <div className="pa2 center">
                        ...
                        <div className="w-50 mh4 text">
                            ...
                            <p className="f4">I am so excited to leverage my computer science and leadership skills to build stellar technology and make the world a better place, so let's team up! Shoot me an email at akshay.sathiya@gmail.com or call/text me at +1-925-548-7652.</p>
                        </div>
