...
const projects = [
    ...
    },
    {
        ...
        name: 'HotSpot',
        descriptions: [
            'An artificial intelligence tool that uses computer vision to detect wildfires in aerial images from planes, drones, satellites, etc. This was inspired by California\'s wildfire crisis in August 2020.',
