...
const workExps = [
    {
        ...
        descriptions: [
            "I am currently developing a system (using Python, PyTorch, and Scikit-learn) for Azure High Performance Computing (HPC) that uses machine learning to determine if Azure Compute instances (nodes) running AI workloads are stable or unstable given their telemetry data (floating-point operations per second, disk performance, model performance, host-to-GPU/GPU-to-host bandwidth, etc.).",
